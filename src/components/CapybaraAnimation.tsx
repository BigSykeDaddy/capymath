...
interface CapybaraAnimationProps {
  ...
  progress: number
  /** once true, we show the “full” tub + bubble and orange */
  finished: boolean
}
...
export default function CapybaraAnimation({
  ...
  // ─── track math ───────────────────────
  const trackWidth = 600         // original design width
  ...
  return (
    <div className="relative w-full max-w-[600px] h-24 overflow-x-hidden mt-44 mx-auto px-4 sm:px-0">
      ...
      >
        <Image
          src={finished ? '/images/sauna-complete.png' : '/images/sauna-empty.png'}
      ...
      {!finished && (
        <motion.div
          className="absolute w-12 h-12 z-20 left-0"
